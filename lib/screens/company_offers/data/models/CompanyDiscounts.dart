...
class CompanyDiscounts {
  ...
  CompanyDiscounts.fromJson(dynamic json) {
    if (json['items'] != null) {
      _items = [];
  ...
  num? _fromItem;
  num? _toItem;
  CompanyDiscounts copyWith({  List<Items>? items,
    num? totalCount,
    num? totalPages,
    num? fromItem,
    num? toItem,
  }) => CompanyDiscounts(  items: items ?? _items,
...
/// categoryId : 1
/// categoryName : null
/// imageUrls : ["https://journymatedashboard.runasp.net/TravelImages/1/1.jpeg","https://journymatedashboard.runasp.net/TravelImages/1/2.jpeg","https://journymatedashboard.runasp.net/TravelImages/1/3.jpeg"]
/// itineraries : []
