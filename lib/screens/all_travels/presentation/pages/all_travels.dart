...
import '../../../../di.dart';
import '../manager/all_travels_cubit.dart';
import '../widgets/all_travel_card.dart';
            ...
            children: [
              Expanded(
                child: MultiBlocProvider(
                  providers: [
                    BlocProvider(
                      create: (context) => getIt<AllTravelsCubit>()
                        ..getAllTravels(PageIndex: 1, PageSize: 6),
                    ),
                    BlocProvider(
                      create: (context) {
                        ...
                        cubit.setOnFilterChanged(
                          onFilterChanged: ({
                            ...
                            AllTravelsCubit.get(context).getAllTravels(
                              PageIndex: 1,
                              PageSize: 6,
                        ...
                        child: BlocConsumer<AllTravelsCubit, AllTravelsState>(
                          ...
                          builder: (context, state) {
                            ...
                            if (state.allTravelsModel != null) {
                              var cubit = AllTravelsCubit.get(context);
                      ...
                      Positioned(
                        ...
                        child: FadeInUp(
                          ...
                          child: Container(
                            ...
                            child:
                                BlocBuilder<AllTravelsCubit, AllTravelsState>(
                              builder: (context, state) {
                                final cubit = AllTravelsCubit.get(context);
