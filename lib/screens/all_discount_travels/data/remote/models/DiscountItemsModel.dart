class DiscountItemsModel {
  ...
  DiscountItemsModel.fromJson(dynamic json) {
    if (json['items'] != null) {
      _items = [];
      json['items'].forEach((v) {
        _items?.add(DiscountItems.fromJson(v));
      });
    }
  ...
  num? _fromItem;
  num? _toItem;
  DiscountItemsModel copyWith({  List<DiscountItems>? items,
    num? totalCount,
    num? totalPages,
    num? fromItem,
    num? toItem,
  }) => DiscountItemsModel(  items: items ?? _items,
    totalCount: totalCount ?? _totalCount,
    totalPages: totalPages ?? _totalPages,
    fromItem: fromItem ?? _fromItem,
    toItem: toItem ?? _toItem,
  );
  List<DiscountItems>? get items => _items;
...
class DiscountItems {
  ...
  DiscountItems.fromJson(dynamic json) {
    _id = json['id'];
    _title = json['title'];
