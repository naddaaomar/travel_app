...
/// coverImageUrl : "https://journymatedashboard.runasp.net//https://i.pinimg.com/736x/14/7f/ea/147fea20f16d94e7960d2bd3b507fd2e.jpg"
/// profileImageUrl : ""
/// companyProfileImageUrl : "https://journymatedashboard.runasp.net//CompanyImages/1.jpg"
/// included : []
/// notIncluded : []
/// specialOffer : null
/// companyId : 4
...
/// categoryName : null
/// imageUrls : []
/// itineraries : [{"title":"Day 1 of Mediterranean Cruise","dayNumber":1,"description":"Activities: Board ship, Welcome dinner, Evening show","startTime":"08:00:00","endTime":"18:00:00","location":"Multiple Cities","activities":["Board ship","Welcome dinner","Evening show"],"includesBreakfast":false,"includesLunch":false,"includesDinner":true,"notes":"Generated from travel JSON"},{"title":"Day 2 of Mediterranean Cruise","dayNumber":2,"description":"Activities: At sea, Pool activities, Wine tasting","startTime":"08:00:00","endTime":"18:00:00","location":"Multiple Cities","activities":["At sea","Pool activities","Wine tasting"],"includesBreakfast":true,"includesLunch":true,"includesDinner":true,"notes":"Generated from travel JSON"}]
...
class TravelRecommendation {
  ...
  TravelRecommendation.fromJson(dynamic json) {
    _id = json['id'];
    _title = json['title'];
...
TravelRecommendation copyWith({  num? id,
  String? title,
  String? description,
  num? price,
  num? baseCost,
  ...
  List<dynamic>? imageUrls,
  List<Itineraries>? itineraries,
}) => TravelRecommendation(  id: id ?? _id,
  title: title ?? _title,
