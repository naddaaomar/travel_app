/// items : [{"id":0,"title":"string","description":"string","price":0,"baseCost":0,"saleDiscount":0,"startDate":"2025-07-06T11:30:02.818Z","endDate":"2025-07-06T11:30:02.818Z","creationDate":"2025-07-06T11:30:02.818Z","availableSeats":0,"departurePoint":"string","departurePointLat":0,"departurePointLng":0,"destinationCity":"string","destinationCityLat":0,"destinationCityLng":0,"transportationType":"string","amenities":["string"],"coverImageUrl":"string","profileImageUrl":"string","companyProfileImageUrl":"string","included":["string"],"notIncluded":["string"],"specialOffer":"string","companyId":0,"companyName":"string","categoryId":0,"categoryName":"string","imageUrls":["string"],"itineraries":[{"title":"string","dayNumber":0,"description":"string","startTime":"string","endTime":"string","location":"string","activities":["string"],"includesBreakfast":true,"includesLunch":true,"includesDinner":true,"notes":"string"}]}]
/// totalCount : 0
/// totalPages : 0
/// fromItem : 0
/// toItem : 0

class AllNewestModel {
  AllNewestModel({
      List<Items>? items, 
      num? totalCount, 
      num? totalPages, 
  ...
  AllNewestModel.fromJson(dynamic json) {
    if (json['items'] != null) {
      _items = [];
  ...
  num? _fromItem;
  num? _toItem;
AllNewestModel copyWith({  List<Items>? items,
  num? totalCount,
  num? totalPages,
  num? fromItem,
  num? toItem,
}) => AllNewestModel(  items: items ?? _items,
...
/// baseCost : 0
/// saleDiscount : 0
/// startDate : "2025-07-06T11:30:02.818Z"
/// endDate : "2025-07-06T11:30:02.818Z"
/// creationDate : "2025-07-06T11:30:02.818Z"
/// availableSeats : 0
