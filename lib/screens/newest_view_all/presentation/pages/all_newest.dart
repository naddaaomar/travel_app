...
import 'package:p/screens/newest_view_all/presentation/manager/all_newest_cubit.dart';
import 'package:p/screens/newest_view_all/presentation/widgets/newest_card.dart';
...
class AllNewest extends StatelessWidget {
  AllNewest({super.key});
            ...
            children: [
              Expanded(
                child: MultiBlocProvider(
                  providers: [
                    BlocProvider(
                      create: (context) => getIt<AllNewestCubit>()
                        ..getAllNewest(PageIndex: 1, PageSize: 6),
                    ),
                    BlocProvider(
                      create: (context) {
                        ...
                        cubit.setOnFilterChanged(
                          onFilterChanged: ({
                            ...
                            AllNewestCubit.get(context).getAllNewest(
                              PageIndex: 1,
                              PageSize: 6,
                  ...
                  child: Stack(
                    children: [
                      ...
                      Padding(
                        ...
                        child: BlocConsumer<AllNewestCubit, AllNewestState>(
                          ...
                          builder: (context, state) {
                            ...
                            if (state.allTravelsModel != null) {
                              var cubit = AllNewestCubit.get(context);
                      ...
                      Positioned(
                        ...
                        child: FadeInUp(
                          ...
                          child: Container(
                            ...
                            child:
                            BlocBuilder<AllNewestCubit, AllNewestState>(
                              builder: (context, state) {
                                final cubit = AllNewestCubit.get(context);
