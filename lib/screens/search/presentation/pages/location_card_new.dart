...
import 'package:p/screens/search/presentation/widgets/filter_screen.dart';
import 'package:p/screens/search/presentation/widgets/filtering_all_etc.dart';
...
class _LocationCardNewState extends State<LocationCardNew> {
  ...
  void initState() {
    ...
    focusNode.addListener(() {
      ...
      if (focusNode.hasFocus) {
        // Delay navigation slightly to avoid build conflict
        Future.microtask(() {
          // Check again in case user unfocused quickly
          if (focusNode.hasFocus) {
            Navigator.push(
              context,
              MaterialPageRoute(
  ...
  child: FilteringAllEtc(
                  initialText: controller.text,
                ),
),
              ),
            ).then((_) {
              // Reset focus and clear field after coming back
              focusNode.unfocus();
              controller.clear();
