...
class CompanyCardAll extends StatelessWidget {
  CompanyCardAll({super.key, required this.model});
  ItemsCompanies model;

  @override
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        Navigator.push(context, MaterialPageRoute(builder: (context) =>CompanyProfile(id: model.id.toString()) ,));
      },
      child: Container(
