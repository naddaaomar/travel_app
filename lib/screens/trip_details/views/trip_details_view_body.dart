...
import 'package:p/screens/tabs/profile/profile_tabs/favorite_trips_widget/data/model/fav_trip_model.dart';
...
import '../../tabs/profile/profile_tabs/favorite_trips_widget/data/service/favorites_service.dart';
...
class _TripDetailsViewBodyState extends State<TripDetailsViewBody> {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: BlocProvider(
        create: (context) =>
            TravelDetailsCubit(networkInfo: NetworkInfoImpl(Connectivity()))
              ..getTravelDetails(id: widget.id),
        child: BlocConsumer<TravelDetailsCubit, TravelDetailsState>(
          ...
          builder: (context, state) {
            ...
            final isFavoritesLoading = favoritesState is! FavoritesLoaded;
            final isTravelDetailsLoading = state.isLoading;

            bool isFavorite = false;
            if (favoritesState is FavoritesLoaded) {
              isFavorite = favoritesState.favorites
                  .any((f) => f.id == int.parse(widget.id));
            }
                ...
                children: [
                              ...
                              child: Row(
                                children: [
                                  ...
                                  FavoriteButton(
                                    ...
                                    iconSize: 40,
                                    valueChanged: (isNowFavorite) async {
                                      final isAuth =
                                          await FavoriteAuth.checkAuth(context);
                                      if (!isAuth) {
                                        FavoriteAuth.showAuthRequiredMessage(
                                            context);
                                        return false;
                                      }
                  ...
                  Container(
                    ...
                    child: Padding(
                      ...
                      child: isFavoritesLoading && isTravelDetailsLoading
                                ...
                                child: Column(
                                  ...
                                  children:
                                      AnimationConfiguration.toStaggeredList(
                                        ...
                                        BlocBuilder<TravelDetailsCubit,
                                            TravelDetailsState>(
                                          builder: (context, state) {
