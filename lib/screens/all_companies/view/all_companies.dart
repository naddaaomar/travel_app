...
import 'package:p/screens/all_companies/widgets/all_companies_card.dart';
                                  ...
                                  (index) {
                                    return InkWell(
                                      ...
                                      child: AllCompaniesCard(
                                        allCompaniesModel:
                                            state.allCompanies.items![index],
                                      ),
                                    );
                                  },
                                ),
                                itemCount:
                                    state.allCompanies.items?.length ?? 0,
                              ),
                            ],
                          ),
                        );
